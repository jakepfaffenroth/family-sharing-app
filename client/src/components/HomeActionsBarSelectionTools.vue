<template>
  <div class="flex xl:justify-end">
    <!-- Large -->
    <div class="hidden lgX:flex">
      <h4 class="font-lg font-black my-auto">Actions:</h4>
    ...
    <drop-menu
      ...
      :position="'left up'"
      class="hidden smX:block lg:hidden"
    >
      <template #button>
    ...
    <div class="flex ml-0.5 space-x-4 sm:space-x-8">
      ...
      >
        ...
        Remove
        <span class="hidden md:inline-block">from album</span>
      </toolbar-button>
      <toolbar-button
        v-if="IMAGE_SHARE_ENABLED"
        data-test="selectToolsShare"
      ...
      >
        ...
        Delete
        <span class="hidden md:inline-block">Photos</span>
      </toolbar-button>
    </div>
    ...
    >
      <template #button>
        <toolbar-button class="flex my-auto -mr-2 sm:mr-0 pl-0 font-lg font-black">
          Actions
          <span>
            <svg
              class="w-4 mt-0.5 ml-1"
      ...
      <template #listItems>
        <div class="flex">
          ...
          >
            ...
            Add
            <span class="inline-block">to album</span>
          </toolbar-button>
          <toolbar-button
            v-if="IMAGE_SHARE_ENABLED"
            data-test="selectToolsShare"
    ...
    >
      <span v-if="selectedImages.length > 0">
        Clear
        <span class="hidden sm:inline-block">selection</span>
      </span>
...
export default {
  ...
  methods: {
    ...
    openDeleteModal() {
      this.openModal('HomeModalDeleteImage', { imgInfo: this.selectedImages });
    },
    openShareModal() {
      if (this.selectedImages.length > 0) {
...
.disabled-menu-item {
  @apply block w-full text-sm rounded cursor-default text-gray-400 hover:text-gray-400 transition;
}
...
.menu-item {
  @apply block w-full text-sm rounded cursor-pointer text-gray-800 hover:bg-teal-400 hover:text-white transition;
}
