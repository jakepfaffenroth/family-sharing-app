...
// import awsEndpoint from '.../node_modules/vue2-dropzone/src/services/urlsigner.js';
...
export default {
  ...
  mounted() {
    ...
    this.dropzone.on('addedfile', function(file) {
      let isDuplicate = false; // eslint-disable-line
        ...
        if (this.files.length) {
          ...
          for (
            ...
            if (
              ...
              isDuplicate = true; // eslint-disable-line
